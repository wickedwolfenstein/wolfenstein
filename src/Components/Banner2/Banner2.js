    ...
    return (
      <Fragment>
        ...
        >
          ...
          <img
            src={Store.imageUrl}
            //src={!Store.themeToggle ? '0.png' : '0.png'}
          ...
          <div className="ui text container">
            <h1
              className={
                'ui header' +
                (!Store.themeToggle ? ' inverted LSWolfAdjust' : ' LSCatAdjust')
              }
            >
              {this.props.headerText}
            </h1>
            <h2
              className={Store.themeToggle ? ' LSCatAdjust' : ' LSWolfAdjust'}
            >
